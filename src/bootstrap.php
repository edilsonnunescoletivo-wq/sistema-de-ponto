...
function initialize_sqlite(PDO $pdo): void
{
    ...
    CREATE TABLE IF NOT EXISTS employee_schedule_assignments (id INTEGER PRIMARY KEY AUTOINCREMENT, employee_id INTEGER NOT NULL, schedule_id INTEGER NOT NULL, starts_on TEXT NOT NULL, ends_on TEXT, created_at TEXT DEFAULT CURRENT_TIMESTAMP);
    ...
    CREATE TABLE IF NOT EXISTS timecard_acceptances (id INTEGER PRIMARY KEY AUTOINCREMENT, company_id INTEGER NOT NULL, employee_id INTEGER NOT NULL, starts_on TEXT NOT NULL, ends_on TEXT NOT NULL, accepted_name TEXT NOT NULL, acceptance_hash TEXT NOT NULL UNIQUE, ip_address TEXT, accepted_at TEXT DEFAULT CURRENT_TIMESTAMP);"
    );
